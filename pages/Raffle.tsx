...
import { Clock, Ticket, ShieldCheck, Zap, Activity, Loader2, ExternalLink } from 'lucide-react';
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 px-2 md:px-0">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="flex-1 bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-center">
            ...
            <a href={`https://arbiscan.io/address/${ADDRESSES.RAFFLE_MANAGER}`} target="_blank" rel="noopener noreferrer" className="text-[10px] font-black text-blue-400 uppercase tracking-widest flex items-center gap-2">
